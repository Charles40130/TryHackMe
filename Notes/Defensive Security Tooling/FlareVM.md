...
- malware analysis
- incdent responders
- foresics investigations

---
##### Arsenal of tools

#### 1. Reverse Engeeneering & Debugging
...
- **Nmap** - A vulnerability detection and network mapping tool. **Netcat** - Read and write data across network connections with this helpful tool.
#### 6. File Analysis
...
---
#### Commonly Used Tools for Investigation
